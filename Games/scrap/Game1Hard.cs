...
namespace Games.Scrap
{
    public class Game1Hard : A3GameModel
    {
        ...
        Color color2 = Color.FromArgb(200, 0, 200); //1
        Color color1 = Color.FromArgb(150, 0, 255); //2
        Color color3 = Color.FromArgb(50, 0, 255); //3
        public Game1Hard()
        {
        ...
        public override void init()
        {
            ...
            a3ttrSoundlist.Add("BGM", new A3ttrSound(Environment.CurrentDirectory + "\\sound\\demosong.wav"));
            a3ttrSoundlist.Add("levelUp", new A3ttrSound(Environment.CurrentDirectory + "\\sound\\levelUp.wav"));
            a3ttrSoundlist.Add("feedback", new A3ttrSound(Environment.CurrentDirectory + "\\sound\\feedback.wav"));
            a3ttrSoundlist["BGM"].Play();
            a3ttrSoundlist.Add("gameover", new A3ttrSound(Environment.CurrentDirectory + "\\sound\\gameover.wav"));
            a3ttrSoundlist.Add("Buzzer", new A3ttrSound(Environment.CurrentDirectory + "\\sound\\WrongBuzzer.wav"));

            loadAnimation("levelUp", Environment.CurrentDirectory + "\\animation\\gradient2.ttr");

            loadAnimation("gameover", Environment.CurrentDirectory + "\\animation\\gameover.ttr");
            ...
            {   /*the other cases are just in case*/
                case "inactive":
                    ...
                    if (distance != 0)
                    {
                        ...
                        setFadeLed(color, currPos.x, currPos.y, keeptime, fadetime);
